                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="text-start">
                            ...
                            <div className="text-xs text-zinc-400">
                                {currentPlayer.position} • {currentPlayer.age}{t('common.year')} • {currentPlayer.ovr} {t('card.overall')}
                            </div>
                        </div>
                    </div>
                    <ChevronDown
            ...
            {isOpen && (
                <div className="absolute top-full mt-2 start-0 w-full bg-card/95 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl z-50 overflow-hidden">
                    ...
                    >
                        ...
                        <div className="text-start">
                            <div className="font-bold text-sm text-white">{t('coach.player_selector.title')}</div>
                            <div className="text-xs text-zinc-400">{t('coach.player_selector.view_all')}</div>
                        </div>
                    </button>
                            ...
                            filteredPlayers.map((player) => (
                                ...
                                >
                                    ...
                                    <div className="flex-1 text-start">
                                        ...
                                        <div className="text-xs text-zinc-400">
                                            {player.position} • {player.age}{t('common.year')} • {player.ovr} {t('card.overall')}
                                        </div>
                                    </div>
                                </button>
                            ))

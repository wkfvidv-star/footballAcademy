                ...
                <div className="space-y-6">
                            ...
                            <div className="space-y-3">
                                {[
                                    ...
                                    <div key={i} className="p-4 bg-white/5 rounded-2xl border border-white/5 flex items-center justify-between">
                                        <span className="text-[10px] font-black text-white uppercase italic">{item.label}</span>
                                        <span className="text-[9px] font-black text-primary uppercase">{item.time}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <GlassCard title={t('nutrition_hub.hydration')} icon={Apple} variant="muted">
                        <div className="py-4 flex flex-col items-center justify-center text-center">
                            <div className="text-6xl font-black text-primary italic mb-2 tracking-tighter">94%</div>
                            <div className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">{t('nutrition_hub.optimal_range')}</div>

...
export default function TechnicalStats({ data }: TechnicalStatsProps) {
    ...
    const stats = [
        ...
        { label: 'Pass Completion', value: `${passCompletion}%`, icon: (props: any) => <div className="text-blue-400 font-bold text-xs border border-blue-400 rounded px-0.5" {...props}>P</div>, color: 'text-blue-400', bg: 'bg-blue-400/10' },

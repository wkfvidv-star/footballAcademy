...
export default function Sidebar({ role, onClose }: SidebarProps) {
    ...
    return (
        <aside className="w-full h-full bg-[#09090b] flex flex-col overflow-y-auto">
            <div className="p-8">
                <div className="flex items-center justify-between mb-10">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <span className="text-xl font-black text-white italic tracking-tighter uppercase">اكاديمية.</span>
